...
function OrderDetail() {
    return (
        <div className="bg-gray-50">
            <div className="max-w-2xl mx-auto pt-6 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-2">
                    ...
                    <div className="mt-6 lg:mt-0 lg:col-span-5">
                        <div className="grid grid-cols-2 gap-x-6 text-sm py-6 px-4 bg-white border-t border-b border-gray-200 shadow-sm sm:border sm:rounded-lg">
                            <div>
                                <h3 className="mb-6 font-medium text-gray-900">Delivery information</h3>
                                <ButtonModal />
                            </div>
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className=" w-full text-white bg-red-600 mt-1 py-2 px-4 border border-gray-500 rounded-md shadow-sm text-sm font-medium  sm:w-auto sm:mt-0"
                    >
                        Cancel Order
                    </button>
                </div>
