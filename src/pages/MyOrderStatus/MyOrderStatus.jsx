        ...
        <div className="bg-white">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:pb-24 lg:px-8">
                <div className="max-w-xl">
                    <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">My Order</h1>
                </div>

                <div className="mt-4 mb-12">
                    <h2 className="sr-only">Current orders</h2>
                        ...
                        {orders.map((order) => (
                            <div key={order.number}>
                                ...
                                <div className="bg-gray-50 rounded-lg py-6 px-4 sm:px-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 lg:space-x-8">
                                    ...
                                    <div className="flex justify-between pt-6 font-medium text-gray-900 sm:block sm:pt-0">
                                            <dt>Status</dt>
                                            <dd className="sm:mt-1 text-green-400">{order.status}</dd>
                                        </div>
                                    <a
                                        href='/orderDetail'
                                        className="w-full flex items-center justify-center bg-white mt-6 py-2 px-4 border border-gray-500 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto sm:mt-0"
                                    >
                                        View Detail
                                        ...
                                        {order.products.map((product) => (
                                            <tr key={product.id}>
                                                ...
                                                <td className="py-6 font-medium text-right whitespace-nowrap">
                                                    <a href='/detailProduct' className="text-indigo-600">
