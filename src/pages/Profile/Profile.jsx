      ...
      <div>
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0 border border-red-600 rounded-lg">
              {/* <h2 className="text-lg text-gray-900">Avatar</h2> */}
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                          ...
                          >
                            ...
                            <input id="file-upload" name="file-upload" onChange={handleUploadFile} type="file" className="sr-only" />
                          </label>
